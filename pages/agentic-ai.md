...
*   **Interactive Mobile Client:** Paired with a native Android app for on-the-go code review.
...
[View on GitHub](https://github.com/amehran/Multi-Agent-Mobile-UI-Assistant-){: .btn .btn--primary}